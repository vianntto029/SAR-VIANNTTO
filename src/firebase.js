...
import { getFirestore, collection, addDoc, getDocs, query, where, deleteDoc, doc, onSnapshot, orderBy } from 'firebase/firestore'
...
export { db, collection, addDoc, getDocs, query, where, deleteDoc, doc, onSnapshot, orderBy }